export class ServiceDeskUtil {
    ...
    private static serviceDeskKeys: { [id: string]: JiraServiceDeskKey } = {};

    static async getServiceDeskVersion(): Promise<string> {
    ...
    static async isVersionAtLeast(as: string): Promise<boolean> {
    ...
    static async getRequestTypes(serviceDeskKey: JiraServiceDeskKey): Promise<JiraRequestType[]> {
    ...
    static async getServiceDeskKey(projectId: string, projectKey?: string): Promise<JiraServiceDeskKey> {
        //Return buffer
    ...
    static async getCurrentServiceDeskKey(project: JiraProject): Promise<JiraServiceDeskKey> {
        if (project.projectTypeKey === 'service_desk')
            return this.getServiceDeskKey(project.id);
